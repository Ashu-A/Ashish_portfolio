...
<a class="navbar-brand" href="index.html">Ashish Ranjan </a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item nav-item-hover"><a class="nav-link" href="techstack.html">Tech</a></li>
   <li class="nav-item nav-item-hover"><a class="nav-link" href="design.html">Design</a></li>
   <li class="nav-item nav-item-hover"><a class="nav-link" href="https://ashishranjan.hashnode.dev/" target="_blank">Blogs</a></li>
   <li class="nav-item">
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/ashu-ashish/" target="_blank" >
    ...
    <a class="social-button github" href="https://github.com/Ashu-A" target="_blank">
